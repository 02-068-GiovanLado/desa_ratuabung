  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r flex flex-col justify-between py-8 px-6">
        <div>
          <h2 className="text-2xl font-bold text-primary mb-8">Admin Panel<br /><span className="text-base font-normal text-gray-500">Desa Ratu Abung</span></h2>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-10">
          <p className="mb-8 text-lg text-gray-700">Selamat datang di Admin Panel Desa Ratu Abung</p>
          {/* Statistik */}
